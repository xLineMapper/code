...
import edu.umkc.archstudio4.processor.grammar.JavaParser.ClassOrInterfaceModifierContext;
...
public class CoreUtils
{
	...
	static public JavaParser.AnnotationContext toAnnotationContext(ParseTree node)
	{
        if (node instanceof JavaParser.ModifierContext) {
        	ClassOrInterfaceModifierContext classOrInterfaceModifierContext = ((JavaParser.ModifierContext) node).classOrInterfaceModifier();
        	
        	if (classOrInterfaceModifierContext != null) {
        		return classOrInterfaceModifierContext.annotation();
        	}
        } else if (node instanceof JavaParser.VariableModifierContext) {
			return ((JavaParser.VariableModifierContext) node).annotation();
        } else if (node instanceof JavaParser.ClassOrInterfaceModifierContext) {
			return ((JavaParser.ClassOrInterfaceModifierContext) node).annotation();
        }
