...
import edu.umkc.archstudio4.processor.grammar.JavaParser.TypeDeclarationContext;
...
public class Pruner implements Modifier<String>
{
	...
	{
		final boolean isPruned = pruneStndAnnotatedCode(ctx);
		
		if (ctx instanceof TypeDeclarationContext) {
			swallow = swallow && isPruned;
		}
