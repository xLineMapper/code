...
public abstract class JavaProcessor<T> extends JavaBaseListener
{
    ...
    @Override
    public void exitTypeDeclaration(final JavaParser.TypeDeclarationContext ctx)
    {
    	getModifier().modifyStndAnnotatedCode(ctx);
    }
    ...
    @Override
    public void exitMemberDeclaration(final JavaParser.MemberDeclarationContext ctx)
    {
    	getModifier().modifyStndAnnotatedCode(ctx.getParent());
    }
}
